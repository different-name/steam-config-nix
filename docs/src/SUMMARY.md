...
- [Game Files & Mods](./files.md)
- [Desktop Entries](./desktop-entries.md)
- [Non-Steam Apps](./non-steam-apps.md)
- [Global Environment Variables](./environment-variables.md)

# Reference

- [Options Reference](./options.md)
  - [Global Options](./options-global.md)
  - [Steam App Options](./options-apps.md)
  - [Non-Steam App Options](./options-non-steam-apps.md)
